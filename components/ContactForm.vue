...
// Define props for customizable labels and placeholders
...
// Emits events for parent to handle submit and error
...
// Handle field focus: clear error
...
// Validate a single field and set error message
